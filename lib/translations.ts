...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    downloadRangeReport: 'Download Range Report',
    selectDateRangeToDownload: 'Select a date range to download the sales report',
  ...
  fr: {
    ...
    // Date Range Reports
    dateRangeReport: 'Rapport de période',
    selectDateRange: 'Sélectionner une période',
    downloadRangeReport: 'Télécharger le rapport de période',
    selectDateRangeToDownload: 'Sélectionnez une période pour télécharger le rapport des ventes',
    startDate: 'Date de début',
    endDate: 'Date de fin',
    today: 'Aujourd\'hui',
    yesterday: 'Hier',
    last7Days: '7 derniers jours',
    last10Days: '10 derniers jours',
  ...
  ar: {
    ...
    downloadReportForDate: 'تحميل تقرير للتاريخ',
    selectDateToDownload: 'اختر تاريخ لتحميل تقرير المبيعات',
    date: 'التاريخ',
    download: 'تحميل',
    colorVariantHint: 'يمكنك إضافة منتحات بنفس الاسم ولكن بألوان مختلفة (مثال: "قميص" بالأحمر، الأزرق، الأبيض)',
    ...
    downloadRangeReport: 'تحميل تقرير الفترة',
    selectDateRangeToDownload: 'اختر فترة لتحميل تقرير المبيعات',
    startDate: 'تاريخ البدء',
    endDate: 'تاريخ الانتهاء',
    today: 'اليوم',
    yesterday: 'أمس',
    last7Days: 'آخر 7 أيام',
    last10Days: 'آخر 10 أيام',

...
export const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    editSaleDescription: 'تحديث حالة الدفع والمبلغ المدفوع',
    ...
    saleStatus: 'حالة الدفع',
    saleCompleted: 'مكتمل',
    salePending: 'معلق',
    amountPaid: 'المبلغ المدفوع',
    remainingDebt: 'المبلغ المتبقي',
    customerPaidFull: 'العميل دفع المبلغ كاملاً',
    enterAmountPaid: 'أدخل المبلغ الذي دفعه العميل',
